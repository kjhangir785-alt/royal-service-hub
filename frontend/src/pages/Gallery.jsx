...
const FILTERS = ["All", "Workshop", "Service", "Before & After", "Modified Bikes", "Customer Delivery", "Accessories"];
          ...
          <motion.div layout className="mt-10 grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
            <AnimatePresence mode="popLayout">
              {items.map((g, i) => (
                ...
                >
                  <img src={IMAGES[g.img]} alt={g.tag} className="h-full min-h-[180px] w-full object-cover transition-transform duration-700 ease-out group-hover:scale-105" />
